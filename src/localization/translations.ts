...
const sharedExperiencesHi: ExperienceItem[] = [
  ...
  {
    title: "क्लाउड और DevOps इंजीनियर",
    company_name: "Larsen & Toubro Infotech (LTI)",
    icon: "backend.png",
    iconBg: "#162032",
    date: "Sep 2022 - Jul 2024",
    points: [
      "Terraform और Azure DevOps Pipelines से इंफ्रास्ट्रक्चर प्रोविजनिंग ऑटोमेट की, मैन्युअल कार्य 40% घटाया।",
      "Azure DevOps और GitHub Actions पर CI/CD पाइपलाइन बनाई और बनाए रखी।",
      "Docker और Kubernetes (AKS) पर Helm चार्ट्स के साथ कंटेनरीकृत वर्कलोड डिप्लॉय किए; जीरो डाउनटाइम रोलिंग अपडेट किए।",
      "Azure Monitor और Application Insights से ऑब्जर्वेबिलिटी लागू की; 99.9% अपटाइम SLA बनाए रखा और MTTR 30% घटाया।",
    ],
  },
  {
...
const sharedExperiencesAr: ExperienceItem[] = [
  ...
  {
    title: "مهندس سحابة وDevOps",
    company_name: "Larsen & Toubro Infotech (LTI)",
    icon: "backend.png",
    iconBg: "#162032",
    date: "Sep 2022 - Jul 2024",
    points: [
      "أتمتت توفير البنية التحتية باستخدام Terraform وAzure DevOps Pipelines، مما قلل الجهد اليدوي بنسبة 40%.",
      "بنيت وصونت خطوط CI/CD (Azure DevOps وGitHub Actions) للبناء والاختبار والنشر الآلي.",
      "نشرت أعباء عمل حاويات باستخدام Docker وKubernetes (AKS) مع إصدارات Helm؛ تحديثات متدرجة بدون توقف.",
      "طبّقت المراقبة بـAzure Monitor وApplication Insights؛ حافظت على 99.9% SLA وقلصت MTTR بنسبة 30%.",
    ],
  },
  {
...
const sharedExperiencesMl: ExperienceItem[] = [
  ...
  {
    title: "ക്ലൗഡ് & DevOps എഞ്ചിനീയർ",
    company_name: "Larsen & Toubro Infotech (LTI)",
    icon: "backend.png",
    iconBg: "#162032",
    date: "Sep 2022 - Jul 2024",
    points: [
      "Terraform, Azure DevOps Pipelines ഉപയോഗിച്ച് ഇൻഫ്രാസ്ട്രക്ചർ പ്രൊവിഷനിംഗ് ഓട്ടോമേറ്റ് ചെയ്തു; മാനുവൽ പ്രവൃത്തി 40% കുറഞ്ഞു.",
      "Azure DevOps, GitHub Actions എന്നിവ ഉപയോഗിച്ച് CI/CD പൈപ്പ്‌ലൈനുകൾ നിർമ്മിച്ചു; ഡെവ്, സ്റ്റേജിംഗ്, പ്രൊഡക്ഷൻ വഴി ഓട്ടോമേറ്റഡ് ഡിപ്ലോയ്‌മെന്റ്.",
      "Docker, Kubernetes (AKS), Helm ഉപയോഗിച്ച് കണ്ടെയ്നറൈസ്ഡ് വർക്ക്‌ലോഡുകൾ ഡിപ്ലോയ് ചെയ്തു; സീറോ ഡൗൺടൈം റോളിംഗ് അപ്‌ഡേറ്റുകൾ.",
      "Azure Monitor, Application Insights വഴി ഒബ്സർവബിലിറ്റി നടപ്പാക്കി; 99.9% അപ്‌ടൈം SLA നിലനിർത്തി, MTTR 30% കുറഞ്ഞു.",
    ],
  },
  {
...
const sharedExperiencesFr: ExperienceItem[] = [
  ...
  {
    title: "Ingenieur Cloud et DevOps",
    company_name: "Larsen & Toubro Infotech (LTI)",
    icon: "backend.png",
    iconBg: "#162032",
    date: "Sep 2022 - Jul 2024",
    points: [
      "Automatisation du provisionnement d'infrastructure avec Terraform et Azure DevOps Pipelines, reduisant l'effort manuel de 40%.",
      "Construction et maintenance de pipelines CI/CD (Azure DevOps, GitHub Actions) pour le deploiement automatise.",
      "Deploiement de charges de travail conteneurisees avec Docker, Kubernetes (AKS) et Helm; mises a jour sans interruption.",
      "Observabilite avec Azure Monitor et Application Insights; SLA 99.9% maintenu et MTTR reduit de 30%.",
    ],
  },
  {
